...
├── 01-EXECUCAO/              # Guias de execução (estrutura de blocos, visual, setup/deploy)
├── ARQUIVADO/                # Histórico, pesquisa bruta, versões antigas e legados
├── src/                      # Código fonte
...
- `00-CORE/COPY_FINAL.md` — Texto final aprovado (fonte da verdade da narrativa e oferta).
- `00-CORE/DESIGN_SYSTEM.md` — Tokens visuais e regras de UI (fonte da verdade do visual).
- `01-EXECUCAO/GUIA_ESTRUTURA_BLOCOS.md` — Ordem e componentes por seção (execução).
- `01-EXECUCAO/GUIA_ESTRATEGIA_VISUAL.md` — Mapa de mídia por seção (execução).
- `01-EXECUCAO/GUIA_SETUP_DEPLOY.md` — Setup/Deploy padronizado (execução).
...
- **Entregável:** `00-CORE/BRIEFING.md`
...
- **Entregáveis:** `ARQUIVADO/PESQUISA/` + síntese em `00-CORE/INSIGHTS_PESQUISA.md`
...
- **Entregável:** `01-EXECUCAO/GUIA_ESTRUTURA_BLOCOS.md`
...
- **Entregável:** `00-CORE/COPY_FINAL.md`
...
- **Entregável:** `00-CORE/DESIGN_SYSTEM.md`
...
- **Entregável:** `01-EXECUCAO/GUIA_ESTRATEGIA_VISUAL.md`
...
- **Entregável:** projeto buildando + `01-EXECUCAO/GUIA_SETUP_DEPLOY.md` atualizado
...
- **Fonte da verdade da copy:** sempre `00-CORE/COPY_FINAL.md`.
- **Fonte da verdade do visual:** sempre `00-CORE/DESIGN_SYSTEM.md`.
- **Arquivos de execução:** sempre em `01-EXECUCAO/`.
- **Histórico e versões antigas:** sempre em `ARQUIVADO/`.
- **Deduplicação:** se existirem 2+ arquivos com o mesmo objetivo, manter 1 canonical e mover os demais para `ARQUIVADO/_LEGADO_REDUNDANTE/` com prefixo `LEGADO__`.
...
> 3) Garanta as regras: 00-CORE (fontes da verdade), 01-EXECUCAO (guias), ARQUIVADO (histórico).
> 4) Se houver duplicidade de arquivos com mesmo objetivo, mantenha 1 canonical e mova o resto para ARQUIVADO/_LEGADO_REDUNDANTE/ (sem apagar nada).
