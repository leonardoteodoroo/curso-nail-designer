...
const OfertaInicial = React.lazy(() => import("../components/sections/Step09_OfertaInicial").then(module => ({ default: module.OfertaInicial })));
const PriceSpoilerV2 = React.lazy(() => import("../components/sections/Step10_PriceSpoilerV2").then(module => ({ default: module.PriceSpoilerV2 })));
const Garantia = React.lazy(() => import("../components/sections/Step11_Garantia").then(module => ({ default: module.Garantia })));
const FAQ = React.lazy(() => import("../components/sections/Step12_FAQ").then(module => ({ default: module.FAQ })));
const WallOfLove = React.lazy(() => import("../components/sections/Step13_WallOfLove").then(module => ({ default: module.WallOfLove })));
const FinalOfferStitch = React.lazy(() => import("../components/sections/Step14_FinalOfferStitch").then(module => ({ default: module.FinalOfferStitch })));
const ExitIntent = React.lazy(() => import("../components/sections/Step15_ExitIntent").then(module => ({ default: module.ExitIntent })));
