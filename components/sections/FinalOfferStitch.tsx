...
import { Package2, CheckCircle, ArrowRight, Lock, ShieldCheck, Zap } from 'lucide-react';
                        ...
                        <div className="bg-white rounded-2xl border border-zinc-200 p-8 shadow-sm">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="text-[#10b77f] shrink-0" size={24} />
                                    <div className="flex-1 flex justify-between border-b border-dashed border-zinc-200 pb-2">
                                        <span className="text-zinc-700 font-medium">25 Certificados Profissionais</span>
                                        <span className="text-zinc-400 line-through text-sm">R$ 250,00</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="text-[#10b77f] shrink-0" size={24} />
                                    <div className="flex-1 flex justify-between border-b border-dashed border-zinc-200 pb-2">
                                        <span className="text-zinc-700 font-medium">Curso de Extensão de Cílios</span>
                                        <span className="text-zinc-400 line-through text-sm">R$ 297,00</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="text-[#10b77f] shrink-0" size={24} />
                                    <div className="flex-1 flex justify-between border-b border-dashed border-zinc-200 pb-2">
                                        <span className="text-zinc-700 font-medium">Curso Manicure & Pedicure</span>
                                        <span className="text-zinc-400 line-through text-sm">R$ 197,00</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="text-[#10b77f] shrink-0" size={24} />
                                    <div className="flex-1 flex justify-between border-b border-dashed border-zinc-200 pb-2">
                                        <span className="text-zinc-700 font-medium">Kit de Documentos & Fichas</span>
                                        <span className="text-zinc-400 line-through text-sm">R$ 97,00</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle className="text-[#10b77f] shrink-0" size={24} />
                                    <div className="flex-1 flex justify-between pb-2">
                                        <span className="text-zinc-700 font-medium">Participação Sorteio Mensal</span>
                                        <span className="text-zinc-400 line-through text-sm">Inestimável</span>
                                    </div>
                                </li>
                            </ul>
                            <div className="mt-8 pt-6 border-t border-zinc-200 flex justify-between items-center bg-zinc-50 -mx-8 -mb-8 p-8 rounded-b-2xl">
                                <span className="text-lg font-bold text-zinc-500">Valor Total Real:</span>
                                <span className="text-2xl font-black text-zinc-400 line-through decoration-red-500/50 decoration-2">R$ 1.538,00+</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-8">
                        <div className="bg-white rounded-2xl shadow-xl border-2 border-[#10b77f] overflow-hidden relative">
                            ...
                            <div className="bg-emerald-50 p-4 text-center border-b border-emerald-100">
                                <p className="text-emerald-800 font-bold text-sm tracking-wide uppercase">Oferta por Tempo Limitado</p>
                            </div>
                            <div className="p-8 text-center space-y-6">
                                <div className="space-y-1">
                                    <p className="text-zinc-500 text-sm line-through">De R$ 1.482,00 por apenas</p>
                                    <div className="flex items-center justify-center gap-1 text-zinc-900">
                                        <span className="text-2xl font-medium">7x de</span>
                                        <span className="text-6xl font-extrabold tracking-tighter text-[#10b77f]">8,16</span>
                                    </div>
                                ...
                                <div className="pt-4 border-t border-zinc-100 opacity-60 grayscale hover:grayscale-0 transition-all">
                                    <div className="flex justify-center gap-2">
                                        <div className="h-6 w-10 bg-zinc-200 rounded flex items-center justify-center text-[8px] font-bold text-zinc-500">VISA</div>
                                        <div className="h-6 w-10 bg-zinc-200 rounded flex items-center justify-center text-[8px] font-bold text-zinc-500">MC</div>
                                        <div className="h-6 w-10 bg-zinc-200 rounded flex items-center justify-center text-[8px] font-bold text-zinc-500">PIX</div>
                                        <div className="h-6 w-10 bg-zinc-200 rounded flex items-center justify-center text-[8px] font-bold text-zinc-500">ELO</div>
                                    </div>
                                </div>
                            </div>
                        </div>
