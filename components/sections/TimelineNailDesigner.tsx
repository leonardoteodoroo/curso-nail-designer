...
import { Youtube, GraduationCap, AlertTriangle, CheckCircle2, XCircle, Sparkles, Frown, PlayCircle } from 'lucide-react';
...
export const TimelineNailDesigner: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="relative py-20 px-4 max-w-4xl mx-auto font-sans">
                ...
                <div className="space-y-8 md:space-y-12 pl-10 md:pl-12 relative">
                    ...
                    >
                        <p className="text-gray-600 mb-3 text-[13px] md:text-sm leading-snug">
                            ...
                            <br /><br />
                            É um caos total... Você fica <strong className="text-gray-800">mais confusa</strong> do que quando começou.
                        </p>
                    ...
                    <TimelineItemNode
                        icon={<GraduationCap size={16} className="md:w-6 md:h-6 text-green-600" />}
                        title="O Curso Presencial Caro"
                    >
                        <div className="text-gray-600 mb-4 text-[13px] md:text-sm leading-relaxed space-y-3">
                            <p className="italic">Aí você pensa: "Vou fazer um curso presencial."</p>
                            <p>
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-4">
                            ...
                            <div className="group relative rounded-xl overflow-hidden border border-emerald-100 shadow-sm transition-all hover:shadow-md">
                                ...
                                <div className="bg-emerald-50/50 p-2 text-center">
                                    <p className="text-[9px] font-bold text-emerald-700 uppercase tracking-tight mb-0.5">NA AULA</p>
                                    <p className="text-emerald-800 font-bold text-[11px] md:text-xs">Perfeito ✨</p>
                                </div>
                            </div>
                            ...
                            <div className="group relative rounded-xl overflow-hidden border border-rose-100 shadow-sm transition-all hover:shadow-md scale-[1.02]">
                                ...
                                <div className="bg-rose-50/50 p-2 text-center">
                                    <p className="text-[9px] font-bold text-rose-600 uppercase tracking-tight mb-0.5">EM CASA</p>
                                    <p className="text-rose-800 font-bold text-[11px] md:text-xs">Desastre 🤡</p>
                                </div>
                            </div>
                        </div>
                    </TimelineItemNode>
                    ...
                    <TimelineItemNode
                        icon={<AlertTriangle size={16} className="md:w-6 md:h-6 text-orange-500" />}
                    ...
                    >
                        <ul className="space-y-2">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-2 text-gray-700 font-medium text-[11px] md:text-sm">
                                    <span className="text-red-500 font-bold text-xs md:text-base leading-none mt-0.5">✕</span>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100 italic">
                            <p className="text-[13px] md:text-sm text-gray-600 leading-snug">
                                ...
                                <span className="text-pink-600 font-bold">Mas EU sei que é aí que você trava.</span>
                            </p>
                        </div>
                    </TimelineItemNode>
...
const TimelineItemNode: React.FC<TimelineItemProps> = ({ icon, title, children }) => {
    return (
        <motion.div
        ...
        >
            ...
            <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative z-10 w-full overflow-hidden">
                <h3 className="text-base md:text-lg font-serif font-bold text-gray-900 mb-2 leading-tight">{title}</h3>
                {children}
            </div>
        </motion.div>
    );
