        ...
        <section className="min-h-[100dvh] flex flex-col bg-white overflow-hidden relative">
            ...
            <div className="relative flex flex-col md:flex-row md:items-stretch w-full">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-zinc-500 text-xs md:text-sm font-medium mt-1">Uma Cobra</p>
                        <div className="flex items-baseline gap-1 mt-1">
                            <span className="text-red-500 text-2xl md:text-3xl font-black leading-none">R$ 25</span>
                            <span className="text-zinc-400 text-xs md:text-sm font-normal">/unha</span>
                        </div>
                ...
                >
                    <span className="text-zinc-800 text-sm md:text-base font-black tracking-wider">VS</span>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-baseline gap-1.5 mt-1">
                            <span className="text-emerald-600 text-3xl md:text-4xl font-black leading-none">R$ 120</span>
                            <span className="text-zinc-400 text-sm md:text-base font-normal">/unha</span>
                        </div>
            ...
            >
                ...
                <div className="mx-auto w-full max-w-[960px] flex flex-col lg:flex-row gap-12 items-center text-center lg:text-left px-0 py-8">
                    <div className="lg:w-1/2 flex flex-col items-center lg:items-start gap-6">
                        ...
                        <p className="text-[#1b0d10] text-lg leading-relaxed">
                            A ansiedade de não saber quanto cobrar, o medo de perder clientes e a frustração de não ver seu
                            trabalho reconhecido. Chega de olhar o WhatsApp com medo daquela mensagem:{" "}
                            <span className="italic text-[#9a4c59]">"Quanto custa?"</span> e a cliente sumir depois da resposta.
                        </p>
                        <div className="grid grid-cols-1 gap-4 mt-4">
                            <div className="flex items-start gap-4 p-4 rounded-xl bg-[#fcf8f9] border border-[#f3e7e9]">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#1b0d10]">Insegurança Técnica</h4>
                                    <p className="text-sm text-[#9a4c59]">Medo de errar na frente da cliente e manchar sua reputação.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-4 rounded-xl bg-[#fcf8f9] border border-[#f3e7e9]">
                                <div className="p-2 bg-red-100 text-[#ec1337] rounded-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[#9a4c59]">Falta de previsibilidade financeira no final do mês.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
                                <div className="bg-[#075E54] p-3 flex items-center gap-3 text-white">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs opacity-80">visto por último hoje às 14:30</p>
                                    </div>
                                </div>
                                <div
                                    className="bg-[#ECE5DD] p-4 h-64 flex flex-col gap-3 overflow-hidden"
                                    style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuACLJ5IAhx1PBhgztxxh_Eb-TbsvcpRdhH5hYzDun6T90tABaCILwaj4c8ohLKR0RRdwY72_Pggw3C79LDUobRarSeCdn4GYymJVRwrwIYlsCRldtd86ENoKnAXnYXXsmZ5QugxZBMD0_8PqoC2Hm2KML_qydOC1hP65_qeT40gg_TKbXVZaTsOI9KxjBuhVs927zwDQL0eA5YJ8Wh8p8oMFdmN63qz7CtWZMrQQTsfUdhC6rZEGT99pXp4DRHzPSzK2fB1nFKNUSQQ')" }}
                                >
                                    <div className="self-start bg-white p-2 rounded-lg rounded-tl-none shadow-sm max-w-[80%]">
                                        <p className="text-sm text-gray-800">Oi, quanto tá o alongamento?</p>
                                        <span className="text-[10px] text-gray-400 block text-right mt-1">14:28</span>
                                    </div>
                                    <div className="self-end bg-[#DCF8C6] p-2 rounded-lg rounded-tr-none shadow-sm max-w-[80%]">
                                        <p className="text-sm text-gray-800">Oi flor! Está R$ 120,00 com decoração inclusa 🥰</p>
                                    ...
                                    <div className="self-start bg-white p-2 rounded-lg rounded-tl-none shadow-sm max-w-[80%]">
                                        <p className="text-sm text-gray-800">Nossa... a menina aqui do lado faz por 40. Vou ver e te falo.</p>
                ...
                <motion.button
                    ...
                    onClick={() => document.getElementById("oferta-lp2")?.scrollIntoView({ behavior: "smooth" })}
