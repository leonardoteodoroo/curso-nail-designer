    ...
    groups: [
      {
        name: "🦶 Técnica de Pés",
        items: [
          "Anatomia específica dos pés",
          "Cutilagem avançada sem traumas",
          "Esmaltação de longa duração",
        ],
      },
    ],
    callout:
      "Diversificar serviços é o caminho mais rápido para aumentar seu faturamento mensal.",
  },
  {
    icon: Sparkles,
    num: 7,
    ...
    callout:
      "Aumente seu ticket médio oferecendo a experiência completa de relaxamento.",
  },
  {
    icon: Users,
    num: 8,
    ...
    callout:
      "Seja a primeira da sua região a dominar este nicho pouco explorado.",
  },
  {
    icon: Palette,
    num: 9,
    ...
    callout:
      "Para você, Perfeccionista: treine em laranjas antes de ir para a cliente real.",
  },
];
...
const superBonus = {
  ...
  highlight:
    "Isso não é um simples brinde. É o empurrão que falta para quem quer sair do zero. → Porque eu SEI que material custa caro no início",
};
      ...
      <div className="max-w-4xl mx-auto">
          ...
          */}
          <div className="flex justify-center mb-6">
            <img
              ...
              loading="lazy"
              decoding="async"
              className="w-full max-w-2xl rounded-2xl object-cover aspect-[16/9] shadow-md"
            />
          </div>
          ...
          <p className="text-zinc-600 max-w-2xl mx-auto leading-relaxed">
            Depois de 12 anos fazendo unhas e formando mais de 48 mil alunas, eu
            organizei tudo o que aprendi num método passo a passo. Sem
            enrolação, sem teoria inútil. Só o que funciona{" "}
            <strong className="text-zinc-900">
              para que você seja uma profissional de Alto Padrão.
            </strong>
          </p>
        </div>
                            ...
                            <div key={gIdx} className="space-y-3">
                              ...
                              <div className="space-y-2">
                                {group.items.map((item, iIdx) => (
                                  <div
                                    key={iIdx}
                                    className="flex items-start gap-2.5 text-zinc-600 text-sm md:text-base leading-snug"
                                  >
                                    <CheckCircle2
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-zinc-600 max-w-xl mx-auto text-lg">
            Além das{" "}
            <span className="text-emerald-600 font-extrabold">+130 aulas</span>,
            você ainda recebe:
          </p>
        </div>
