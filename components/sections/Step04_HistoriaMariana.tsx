...
const afterItems = [
  ...
  {
    icon: BellOff,
    label: "Zero cancelamentos",
    sub: "Trabalha apenas com sinal",
  },
];
...
const chatMessages = [
  ...
  {
    text: "Porque se eu cobrar mais caro e ficar ruim, vou morrer de vergonha. 😰",
    time: "10:24",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
            ...
            {(
              [
                ...
                },
                {
                  text: (
                    <>
                      Só que a reviravolta que ela deu não apenas resgatou a
                      saúde do parceiro, como{" "}
                ...
                <div className="bg-[#075E54] p-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/60">
                      visto por último hoje às 10:20
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            <blockquote
              ...
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              "Eu olhava pras minhas unhas e pensava: 'isso nunca vai ficar bom
              o suficiente'. Mas a verdade é que eu nunca tinha aprendido o
              método certo.{" "}
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 text-sm md:text-base mt-2">
              ...
              Que <span className="text-zinc-900 font-bold">SÓ ELA vê</span>. A
              cliente? <span className="text-emerald-600 font-bold">Ama.</span>
            </p>
          </div>
          ...
          <div className="bg-orange-50/30 border border-orange-100 rounded-2xl p-6 md:p-10 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              <div className="text-sm md:text-base text-zinc-700 space-y-2">
                <p>
                  Ela aprendeu <strong>ONDE PARAR.</strong>
                </p>
                <p>
                  Aprendeu que{" "}
                  <em>"bom o suficiente" &gt; "perfeito paralisante"</em>.
                </p>
                <p>
                  E principalmente: aprendeu <strong>o que FALAR</strong> quando
                  a cliente olha a unha.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-6 p-4 md:p-6 bg-[#efeae2] rounded-2xl relative overflow-hidden border border-zinc-200">
                ...
                <div className="flex justify-start relative z-10">
                  <div className="bg-white px-3 py-2 rounded-lg rounded-tl-none shadow-sm border border-zinc-100 max-w-[85%] relative">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 mb-0.5 uppercase tracking-tight">
                      Cliente
                    </p>
                    <p className="text-zinc-800 text-sm md:text-base">
                      Nossa, ficou lindo! Como você fez isso?
                    </p>
                ...
                <div className="flex justify-end relative z-10 opacity-60">
                  <div className="bg-[#f0f0f0] px-3 py-2 rounded-lg rounded-tr-none border border-zinc-200 max-w-[85%] relative">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 mb-0.5 text-right uppercase tracking-tight">
                      Antes ela respondia
                    </p>
                ...
                <div className="flex justify-end relative z-10">
                  <div className="bg-[#dcf8c6] px-3 py-2 rounded-lg rounded-tr-none shadow-sm border border-[#c7eab0] max-w-[85%] relative">
                    ...
                    <p className="text-[10px] font-bold text-emerald-600 mb-0.5 text-right uppercase tracking-tight">
                      Hoje ela responde
                    </p>
                    <p className="text-zinc-800 text-sm md:text-base font-medium leading-tight">
                      Usei a técnica de estruturação em camadas, por isso fica
                      tão resistente. Vai durar fácil 20 dias.
                    </p>
        ...
        >
          <h3 className="font-serif font-bold text-amber-600 mb-6 flex flex-col items-center">
            <span className="text-xl md:text-3xl opacity-80">
          ...
          <p className="text-lg md:text-xl text-zinc-500 mb-2">
            A cliente paga R$ 100 e sai pensando:
          </p>
        ...
        <div className="mt-16 md:mt-24">
          <p className="text-center text-zinc-500 mb-8 font-medium">
            Esse é apenas UM exemplo. Eu poderia te contar:
          </p>
            ...
            <div className="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-zinc-100 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] md:text-xs text-zinc-500">
                  tinha vergonha de vender, hoje cobra R$ 150
                </p>
              </div>
            </div>
            <div className="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-zinc-100 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] md:text-xs text-zinc-500">
                  de 1 cliente/mês para agenda lotada
                </p>
              </div>
            </div>
            <div className="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-zinc-100 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] md:text-xs text-zinc-500">
                  ODEIA Instagram, agenda lotada via WhatsApp
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xl md:text-3xl font-bold text-zinc-900">
              É sobre aprender o{" "}
              <span className="text-amber-500 uppercase">SISTEMA CERTO.</span>
            </p>
          </div>
          ...
          <div className="mt-16 flex flex-col items-center gap-3">
            <button
              onClick={() =>
                document
                  .getElementById("anti-climax-lp2")
