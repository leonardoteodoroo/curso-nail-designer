...
import { Lock, Eye, Timer, RefreshCcw, AlertCircle, Check, ShieldCheck, Zap } from 'lucide-react';
...
export const PriceSpoilerV2: React.FC<PriceSpoilerV2Props> = ({
            ...
            timerRef.current = setInterval(() => {
                setTimeLeft((prev) => {
                    ...
                    if (newValue <= 0) {
                        ...
                        setStatus('expired');
                        sessionStorage.setItem(STORAGE_KEY, JSON.stringify({ status: 'expired', endTime: 0 }));
    ...
    const handleReveal = () => {
        ...
        sessionStorage.setItem(STORAGE_KEY, JSON.stringify({ status: 'revealed', endTime }));
                        ...
                        {status === 'revealed' && (
                            ...
                            >
                                ...
                                <div className="px-6 sm:px-8 pb-8 pt-6 w-full flex flex-col items-center space-y-6 text-center">
                                    ...
                                    <div className="w-full p-4 bg-orange-50/80 rounded-xl flex items-center justify-between" role="timer" aria-live="polite">
                                        <div className="flex items-center gap-2 text-orange-800">
                                            <Timer className="w-5 h-5 animate-pulse" />
                                            <span className="font-semibold text-[13px] sm:text-sm">Preço reservado por:</span>
                                        </div>
                        ...
                        {status === 'expired' && (
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-xl font-bold text-gray-800">Reserva expirada</h3>
