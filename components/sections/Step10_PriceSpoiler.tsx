            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <p className="font-medium text-gray-700">
                                O preço tá aqui… mas tá de spoiler <span role="img" aria-label="smile">😄</span>
                            </p>
                ...
                {status === 'revealed' && (
                    ...
                    >
                        ...
                        <div className="w-full p-4 bg-orange-50 rounded-xl border border-orange-100 flex items-center justify-between" role="timer" aria-live="polite">
                            <div className="flex items-center gap-2 text-orange-800">
                                <Timer className="w-5 h-5 animate-pulse" />
                                <span className="font-semibold text-sm">Preço reservado por:</span>
                            </div>
