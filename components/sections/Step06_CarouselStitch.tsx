...
const stitchReviews: StitchReview[] = [
    {
        ...
        detail: 'Eu refazia a MESMA unha 6, 7 vezes. Chorava de frustração. Achava que nunca ia ficar "perfeita". Hoje eu entendo: perfeito NÃO EXISTE. E minhas clientes AMAM meu trabalho. Cobro R$ 100. Agenda fechada. E EU durmo tranquila.',
        status: 'Ex-perfeccionista paralisada',
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBBNGfvLNVrg6zJ_kReJojtdFiNYlhHt6VAKZfLRpsaikpoYiu4QYM4LH6Z6Y-oDNen8ES8Az6Klt0tBXj1z9QXZU8Y1qK_gQ_6uYn-0IYJZVPTi3Lc0ubI4P2Y9mo8TGsmX6sszOYUFe1BkUV-zAgpbeQAyYLkCVeGkQdvTCaM_r8BnZRwSVPXafoA5-3DF-CSJubNUVjZMFQGTor1vCNnqu4G4-R3eUNh5Jhq1_hTrrrspH1c6-3TPt38Dia1YkCjZCKCljpwoLU',
        initial: 'M',
    },
    {
        id: 2,
        ...
        detail: 'Meu marido perdeu o emprego e entrou em depressão. O desespero bateu… Mas eu tinha minha profissão. Trabalhei dobrado. Paguei aluguel. Fiz mercado. Segurei a barra sozinha. Hoje eu sei: Meu Studio não é "bico". É o sustento da minha família.',
        status: 'Sustenta a casa sozinha',
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDDin-eqtWk3_V8DOjBhFfNUGhuxjrGBB0MMNSt3osocJDbN20-IYrISMnHExqN4gNdwfdhYzumnnoh37lD5SHI313bL0W22Qe7e8zrY1b1iNNd79hb-X80B1zAgtKrjCvD6ATE1AEQUm-HGfrglayPZLV1HLWqQND6kdJUCbsN-0RUUiTKyYHJDY3Q71CXluIGK21gwwNj6ToS7PRyZ2thckJsrqVnQYGEEZOnqHgGK0mQrEvPeLyU1gXtRrFVjkephf-MRcXxauI',
        initial: 'V',
        isTop: true,
    },
    {
        ...
        detail: 'Eu tinha VERGONHA de falar meu preço. "Quanto é?" — "Ahh… R$ 40…" (morrendo por dentro). Hoje respondo com SEGURANÇA: "R$ 120. Aceita cartão ou Pix?" O que mudou? EU mudei.',
        status: 'Aprendeu a se valorizar',
        image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAJS4dSC7OCp-SmDkmgCZCcBEgq1Biu-LCtJypuIFfOs8nPR2DRg8O2AQC1CAicCk-R74CSs1COXBDudA5Se3wrTmxN21L1O6Rxu1ZUTZLUoE0giixt6UWF2w3x4IzndZXAsPKkO9OLBosj8tJuLYGW_PvRru9snG7y36tkCmv4vc6SxPHMsO3yFw5ENXNbJBRh7z5U4BGlyckjp7tTkpt_n8yyjEsjTOWfzTj2XyXo0F238x-WaK4g778T0CVVo4Zx0PpqXnBD7hY',
        initial: 'C',
    },
    {
        id: 4,
        ...
        detail: 'Eu tremia LITERALMENTE na frente da cliente. Suava frio. Mão tremendo. Pensava: "Ela tá julgando tudo que eu faço." Descobri que isso é ANSIEDADE SOCIAL. E que dá pra trabalhar mesmo com isso. Hoje minha agenda vive lotada. E não tremo mais.',
    ...
    },
    {
        ...
        detail: 'Eu ODEIO aparecer. Não posto foto. Não faço stories. Nem tenho Instagram profissional. E mesmo assim… Minha agenda lota SÓ com WhatsApp e indicação. Você NÃO precisa ser influencer pra viver disso.',
    ...
    },
    {
        ...
        detail: 'Já fiz 3 cursos de unha. Gastei mais de R$ 2.000. NENHUM me ensinou como REALMENTE trabalhar. Só técnica. Nada de negócio. Nada de confiança. Esse foi o PRIMEIRO que me fez virar profissional DE VERDADE. Hoje eu faturei R$ 4.800 no último mês.',
    ...
    },
    {
        ...
        detail: '"Eu não tenho dom." "Não nasci pra isso." EU me sabotava TODOS OS DIAS. Até entender: Dom é MITO. Técnica é TREINO. Hoje eu sou a manicure mais procurada do meu bairro. E eu NÃO nasci sabendo. EU APRENDI.',
    ...
    },
    {
        ...
        detail: 'Tenho 2 filhos pequenos. Toda vez que eu pensava em trabalhar… Vinha a CULPA. "Sou má mãe por querer ganhar meu dinheiro?" Hoje eu trabalho em casa. Atendo enquanto eles dormem ou estão na escola. Faturei R$ 3.200 mês passado. E meus filhos estão ÓTIMOS.',
    ...
    },
    {
        ...
        detail: 'Nunca tinha pegado no alicate. ZERO experiência. Comecei do absolutamente NADA. 3 meses depois: Primeira cliente pagante. R$ 80. EU chorei de emoção. Hoje, 1 ano depois, atendo 4 clientes/dia.',
    ...
    },
    {
        ...
        quote: '"Me Valorizei"',
        detail: 'Eu JÁ fazia unha há 5 anos. Mas ganhava MIXARIA. R$ 30, R$ 40… "Pra ajudar a pagar conta." O problema NÃO era técnica. Era PRECIFICAÇÃO + POSICIONAMENTO. Hoje cobro R$ 110. É a MESMA unha. Mas eu me valorizo.',
    ...
    },
    {
        ...
        detail: 'Sou MUITO tímida. Cliente cancelava última hora… Eu não tinha coragem nem de cobrar a taxa. "Tá ok, sem problemas!" (chorando por dentro). Aprendi SCRIPTS PRONTOS. Hoje eu tenho POLÍTICA DE CANCELAMENTO. E as clientes respeitam. Mudou TUDO.',
    ...
    },
    {
        ...
        location: 'Brasília',
        quote: '"Perdi o Medo"',
        detail: 'Eu tinha PAVOR de cliente "chata". "E se ela reclamar?" "E se ela me humilhar?" Aprendi a fazer ANAMNESE. Aprendi a ALINHAR EXPECTATIVA. Aprendi o que FALAR se der errado. Hoje eu atendo até as "difíceis". E elas viram minhas clientes fiéis.',
    ...
    },
    {
        ...
        detail: 'Eu achava que ninguém ia pagar R$ 100 aqui no meu bairro. "As meninas daqui não têm dinheiro." Era o que EU pensava. Mas aprendi: Quanto mais LONGE dos salões chiques… MAIOR a fidelidade da cliente. Minhas clientes não me trocam. Agenda lotada só com indicação. Zero gasto com anúncio.',
    ...
    },
    {
        ...
        detail: 'Cidade pequena não dá dinheiro. Era o que EU acreditava. Mas descobri: Quanto MENOR a cidade… MENOS concorrência. Sou a ÚNICA da minha região que faz fibra de vidro profissional. Clientes vêm de 3 cidades vizinhas pra mim.',
...
const StitchCardInner: React.FC<{ review: StitchReview; isCenter: boolean }> = ({ review, isCenter }) => {
    return (
        <div className={`bg-white h-full flex flex-col transition-shadow duration-300 ${isCenter
            ...
            <div className="relative overflow-hidden shrink-0 h-56 w-full">
                ...
                {review.isTop && (
                    ...
                    <div className={`absolute top-4 right-4 bg-white/20 backdrop-blur-md px-3 py-1 rounded-lg border border-white/30 transition-opacity duration-300 ${isCenter ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="relative flex flex-col flex-1 p-5">
                <span className={`inline-flex items-center self-start px-3 py-1 rounded-full text-xs font-semibold mb-2 transition-colors duration-300 ${isCenter
                    ? 'bg-[#ee2b5b] text-white'
                    : 'bg-rose-50 text-[#ee2b5b]'
                    }`}>
                    {review.status}
                </span>
...
export const CarouselStitch: React.FC = () => {
    ...
    const prevSlide = () => jumpTo((activeIndex - 1 + stitchReviews.length) % stitchReviews.length);
    ...
    return (
        <section className="w-full py-12 lg:py-20 relative bg-[#f8f6f6]" style={{ overflowX: 'hidden' }}>
            {/* Background Decor */}
                    ...
                    <div className="text-left space-y-6 relative z-20">
                        ...
                        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-gray-900 leading-tight">
                            ...
                            <span className="text-[#ee2b5b] relative inline-block">
                                EXATAMENTE
                                <svg className="absolute w-full h-3 -bottom-1 left-0 text-rose-300" preserveAspectRatio="none" viewBox="0 0 100 10">
                        ...
                        <p className="text-lg text-gray-500 max-w-md">
                            Hoje elas vivem da Nail Art, conquistaram sua independência financeira e faturam alto. O próximo depoimento pode ser o seu.
                        </p>

                        <div className="flex items-center gap-4 pt-2">
                            <div className="flex -space-x-3">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-rose-100 flex items-center justify-center text-[#ee2b5b] text-xs font-bold">
                                        {i}
                                    </div>
                                ))}
                            </div>
                            <div className="text-sm text-gray-500">
                                <span className="text-[#ee2b5b] font-bold">48.000+</span> Alunas Transformadas
                            </div>
                        </div>
                        ...
                        <div className="hidden md:flex gap-4 mt-4 w-max">
                            <div className="flex gap-4 items-center">
                                ...
                                >
                                    <ChevronLeft className="text-gray-500 group-hover:text-[#ee2b5b]" size={24} />
                                </button>
                                ...
                                <button
                                    ...
                                    className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center bg-white hover:bg-rose-50 hover:border-rose-200 transition-all group shadow-sm"
                                >
                                    <ChevronRight className="text-gray-500 group-hover:text-[#ee2b5b]" size={24} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="hidden md:flex flex-col items-start gap-2 mt-6">
                            <button
                                onClick={() =>
                                    document.getElementById("modulos-lp2")?.scrollIntoView({ behavior: "smooth" })
                                }
                    ...
                    <div className="relative flex flex-col items-center justify-center overflow-visible">
                        ...
                        <div className="flex md:hidden flex-col items-center mt-6 gap-4 relative z-50 pointer-events-none w-full px-4">
                            ...
                            <div className="flex items-center gap-2 opacity-80">
                                <span className="text-[#ee2b5b] font-serif italic text-xs tracking-wide">Deslize para ler</span>
                                <MoveRight className="text-[#ee2b5b] animate-pulse motion-reduce:animate-none" size={20} />
                            </div>
...
const CarouselCardStitch: React.FC<CarouselCardStitchProps> = ({ index, review, x, gap, shouldReduceMotion }) => {
    ...
    const opacity = useTransform(position, [-gap * 1.5, 0, gap * 1.5], [0.4, 1, 0.4]); // Opacidade suave nos laterais
    const blur = useTransform(
        position,
        [-gap, 0, gap],
        shouldReduceMotion ? [0, 0, 0] : window.innerWidth < 768 ? [0.5, 0, 0.5] : [1, 0, 1]
    );
